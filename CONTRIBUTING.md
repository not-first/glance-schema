...
**Remove this `schema.json` file from your commit**, as it is built by a Github Action when pull requests are merged or manually triggered to ensure consistency. A locally generated schema will function the same as one generated by the workflow.
